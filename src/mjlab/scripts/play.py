...
##导出scene
  # out_dir = Path("/tmp/mjlab/exports");
  # out_dir.mkdir(parents=True, exist_ok=True)
  # zip_path = out_dir / f"{task.replace(':', '_')}_scene.zip"
  #
  # env.env.scene.to_zip(zip_path)
  # print(f"[DUMP] Scene exported to: {zip_path.resolve()}")
