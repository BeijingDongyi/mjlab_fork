...
from mjlab.tasks.box_task.config.phybot_mini.flat_env_cfg import PhybotC1FlatEnvCfg
  ...
  while not file_saved:
    ...
    if not file_saved:
      ...
      if reset_flag and not file_saved:
        ...
        run = wandb.init(
          project="csv_to_npz", name=COLLECTION, entity="hongyichen16-university-of-shanghai-for-science-and-tech"
        )
...
def main(
  ...
  scene = Scene(PhybotC1FlatEnvCfg().scene, device=device)
  model = scene.compile()
